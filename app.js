        ...
        <div class="hero-card">
          <div class="hero-content">
            ...
            <div class="hero-meta">
              ...
              <div class="meta-pill">Pedido minimo: 3 alfajores</div>
            </div>
          </div>
        </div>
...
function renderCheckout() {
  ...
  const alfajorCount = getAlfajorCount();
        ...
        <div class="checkout-summary">
          ...
          <div class="summary-box">
            ...
            <div class="summary-meta">
              <span>Alfajores en el pedido: ${alfajorCount}</span>
      ...
      <div class="container footer-shell">
        ...
        <div class="footer-column">
          ...
          <ul class="footer-list">
            <li>Minimum order: 3 alfajores</li>
...
function submitCheckout(formElement) {
  ...
  if (getAlfajorCount() < 3) {
    nextErrors.push("El pedido debe incluir al menos 3 alfajores en total.");
  }
